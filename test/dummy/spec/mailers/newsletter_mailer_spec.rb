...
describe GoldencobraNewsletter::NewsletterMailer do
  describe "Newsletter" do
    ...
    #   @newsletter_registration = mock_model(GoldencobraNewsletter::NewsletterRegistration, user: @user, is_subscriber: true, company_name: "ikusei", newsletter_tags: "default")
    # end
    ...
    #   newsletter_template = mock_model(GoldencobraEmailTemplates::EmailTemplate, subject: "My Awesome Email", title: "My Email title", content_html: "My content", template_tag: "default")
    #   email = GoldencobraNewsletter::NewsletterMailer.email_with_template(@newsletter_registration, newsletter_template).deliver
    ...
    #   newsletter_template = mock_model(GoldencobraEmailTemplates::EmailTemplate, template_tag: "default")
    #   email = GoldencobraNewsletter::NewsletterMailer.email_with_template(@newsletter_registration, newsletter_template).deliver
    # end
